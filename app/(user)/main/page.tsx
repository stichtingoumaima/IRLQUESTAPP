  ...
  return (
    <div className="z-50">
      <Drawer direction="right">
        ...
        <DrawerContent className="right-0 top-0 mt-0 w-12/12 sm:z-10 md:z-10 lg:z-50 xl:z:50   flex flex-row md:w-5/12 border-l-gray-500 border-2 w-full h-screen">
            ...
            <div className="overflow-y-scroll overflow-x-hidden px-7 space-y-3">
              ...
              >
                <div className="flex items-center justify-start px-5 gap-4">
                  <span className="text-4xl text-center font-bold text-[#D1EBFE] drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.5)]">
                   Dungeons
                  </span>
                </div>
              </button>
